...
# console-log an 'A', between 80 and 89, console-log a 'B', between 70 and 79, 'C', between 60 and 69, 'D', 
...
friends.insert(2, 'Third Name')
print(friends)

# Problem 15
# Remove the last item in the array (try to think about how you can do this dynamically, meaning, 
# if the array contents were to change, your code would still work).
friends.pop()
print(friends)